                                    ...
                                    <div className="fbox-ico-wrap">
                                        <div className="fbox-ico ico-50">
                                            <div className="shape-ico color--theme">
                                                {/* Image */}
                                                <img className="img-fluid" src="/images/club1.png" alt="Content Image" style={{width: '100%', height: 'auto'}} />
                                            </div>
                                        </div>
                                    </div>	{/* End Icon */}
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Aust Innovation and design Club</h6>
                                ...
                                <div className="fbox-11 fb-2 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico-wrap">
                                        <div className="fbox-ico ico-50">
                                            <div className="shape-ico color--theme">
                                                {/* Image */}
                                                <img className="img-fluid" src="/images/club2.png" alt="Content Image" style={{width: '100%', height: 'auto'}} />
                                            </div>
                                        </div>
                                    </div>	{/* End Icon */}
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">AUST Blood Donation Club</h6>
                                        <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and
                                            tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum
                                        </p>
                                    </div>
                                ...
                                <div className="fbox-11 fb-3 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico-wrap">
                                        <div className="fbox-ico ico-50">
                                            <div className="shape-ico color--theme">
                                                {/* Image */}
                                                <img className="img-fluid" src="/images/club3.png" alt="Content Image" style={{width: '100%', height: 'auto'}} />
                                            </div>
                                        </div>
                                    </div>	{/* End Icon */}
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">AUST Sports Club</h6>
                                        <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and
                                            tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum
                                        </p>
                                    </div>
                                ...
                                <div className="fbox-11 fb-4 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico-wrap">
                                        <div className="fbox-ico ico-50">
                                            <div className="shape-ico color--theme">
                                                {/* Image */}
                                                <img className="img-fluid" src="/images/club4.png" alt="Content Image" style={{width: '100%', height: 'auto'}} />
                                            </div>
                                        </div>
                                    </div>	{/* End Icon */}
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">AUST Debating Club</h6>
                                        <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and
                                            tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum
                                        </p>
                                    </div>
                                ...
                                <div className="fbox-11 fb-5 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico-wrap">
                                        <div className="fbox-ico ico-50">
                                            <div className="shape-ico color--theme">
                                                {/* Image */}
                                                <img className="img-fluid" src="/images/club5.png" alt="Content Image" style={{width: '100%', height: 'auto'}} />
                                            </div>
                                        </div>
                                    </div>	{/* End Icon */}
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">AUST AHSANULLAH (R.) PEACE CLUB</h6>
                                        <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and
                                            tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum
                                        </p>
                                    </div>
                                ...
                                <div className="fbox-11 fb-6 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico-wrap">
                                        <div className="fbox-ico ico-50">
                                            <div className="shape-ico color--theme">
                                                {/* Image */}
                                                <img className="img-fluid" src="/images/club10.png" alt="Content Image" style={{width: '100%', height: 'auto'}} />
                                            </div>
                                        </div>
                                    </div>	{/* End Icon */}
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">AUST Programming and Informatics Club</h6>
                                        <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and
                                            tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum
                                        </p>
                                    </div>
