        ...
        <>
            <ul className="wsmenu-list nav-theme">
                ...
                <li aria-haspopup="true" className="mg_link">
                    ...
                    <Link to="#" className="h-link">Pages <span className="wsarrow" /></Link>
                ...
                {/* SIMPLE NAVIGATION LINK */}
                <li className="nl-simple" aria-haspopup="true"><Link to="/pricing-1" className="h-link">Pricing</Link></li>
                {/* SIMPLE NAVIGATION LINK */}
